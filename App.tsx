...
const CONFIG = {
  ...
  brandName: "DDM PATRICK RADOM",
  brandSubtitle: "DACHDECKERMEISTERBETRIEB",
  badgeText: "EXKLUSIVER DESIGN-ENTWURF",
  headlinePart1: "Dein Dach in besten Händen. ",
  headlinePart2: "Ob Sonne, Regen oder Sturm.",
  subheadline: "Ein maßgeschneidertes, digitales System für den Dachdeckermeisterbetrieb Patrick Radom. Entwickelt, um erstklassiges Handwerk (Dachdecken • Sanieren • Abdichten) online sichtbar zu machen, neue Fachkräfte zu gewinnen und Projektanfragen digital zu organisieren.",
...
export default function App() {
  ...
  const [applicantCount, setApplicantCount] = useState<number>(6);
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-neutral-900 font-sans antialiased selection:bg-orange-500/10 selection:text-orange-900">
      
      {/* 1. TOP BAR BANNER */}
      <div className="bg-[#262626] text-white py-2.5 text-[10px] font-mono tracking-[0.2em] text-center px-4 relative z-50 shadow-xs">
        {CONFIG.topBarText}
      </div>
      ...
      <header className="border-b border-neutral-200/60 bg-white/80 backdrop-blur-md sticky top-0 z-40 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] uppercase tracking-[0.2em] text-orange-600 font-semibold mt-0.5">
          ...
          <nav className="hidden md:flex space-x-8 text-xs uppercase tracking-widest text-neutral-400 font-medium">
            <span className="text-orange-600 font-semibold cursor-default flex items-center gap-1">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden sm:inline-flex items-center gap-1.5 bg-orange-600/5 border border-orange-600/10 px-3 py-1 rounded-full text-[10px] font-mono text-orange-600">
              <span className="h-1.5 w-1.5 rounded-full bg-orange-500 animate-ping"></span>
              PROTOTYP
            </div>
            <button 
              onClick={() => setDemoActive(true)}
              className="bg-[#262626] text-white uppercase text-[10px] tracking-widest font-semibold px-5 py-3 hover:bg-neutral-800 active:scale-98 transition-all duration-200 shadow-sm cursor-pointer"
            >
              Konzept öffnen
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-neutral-900 leading-[1.1]">
              ...
              <span className="bg-gradient-to-r from-orange-600 to-amber-700 bg-clip-text text-transparent italic font-serif font-normal">
              ...
              {[
                {
                  ...
                  title: "Dach-Recruitingtool",
                  desc: "Gesellen, Helfer oder Azubis bewerben sich mobil in 60 Sekunden – unkompliziert per Smartphone ohne Lebenslauf-Stress."
                },
                {
                  icon: <CalendarRange className="w-4 h-4 text-orange-600" />,
                  title: "Digitaler Anfrage-Planer",
                  desc: "Kunden übermitteln Maße, Schadensbilder oder Sanierungswünsche direkt online. Filtert unqualifizierte Anfragen sofort heraus."
                }
              ].map((feat, idx) => (
                <motion.div 
                  key={idx}
                  whileHover={{ y: -4, borderColor: "rgba(234, 88, 92, 0.3)" }}
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md bg-white border border-neutral-200 rounded-3xl p-5 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.07)] space-y-4 backface-visible transform-gpu"
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-inner border border-neutral-200/80 aspect-[4/3] bg-neutral-50 group">
                {CONFIG.imageUrl ? (
                  <img 
                    src={CONFIG.imageUrl} 
                    alt="Dachdecker Handwerk" 
                    className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-105" 
                  />
                ) : (
                  <div className="absolute inset-0 bg-gradient-to-tr from-orange-500/10 to-neutral-50 flex flex-col items-center justify-center text-neutral-400 p-4">
                ...
                <div className="absolute bottom-3 left-3 text-white pointer-events-none">
                  ...
                  <span className="text-xs font-semibold tracking-wide">Dachdecken • Sanieren • Abdichten</span>
                </div>
              </div>
              ...
              <div className="p-4 bg-neutral-50/80 border border-neutral-200/70 rounded-2xl flex items-center justify-between shadow-xs">
                <div className="space-y-0.5">
                  ...
                  <div className="text-xs font-bold text-neutral-800 flex items-center gap-2">
                    <span>{applicantCount} Projektanfragen diesen Monat</span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="space-y-4 text-center">
                <div className="w-12 h-12 rounded-full bg-orange-600/10 text-orange-600 flex items-center justify-center mx-auto">
                  <Compass className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold">Hinweis zum Prototyp</h3>
                <p className="text-neutral-500 text-xs leading-relaxed">
                  Dieses System befindet sich im exklusiven Demo-Modus für den Betrieb Patrick Radom. Nach Freischaltung werden alle interaktiven Formulare, Dach-Konfiguratoren und Daten-Pipelines voll funktionsfähig hinterlegt.
                </p>
                ...
                <div className="p-3.5 bg-neutral-50 rounded-xl border border-neutral-200 text-left font-mono text-[10px] text-neutral-500 space-y-1">
                  ...
                  <div className="text-neutral-800 font-semibold">- Live-Schnittstelle für Schadensmeldungen (Sturmschaden-Upload)</div>
                  <div className="text-neutral-800 font-semibold">- Automatischer WhatsApp-Kanal für schnelle Terminabsprachen</div>
                </div>
